                ...
                <div class="row">
                    <div class="col-md-6 offset-md-3">
                        <div class="home_right_box">
                            ...
                            <form class="card-body p-lg" method="POST" action="{{ route('usuarios.update', $user->id) }}">
                                @if (session('mensagem'))
                                ...
                                <div class="mb-3">
                                    <label>Nome</label>
                                    <input type="text" class="form-control" id="Username" aria-describedby="E-mail" value="{{$user->name}}"
                                        name="name" placeholder="E-mail">
                                </div>
                                <div class="mb-3">
                                    <label>E-mail</label>
                                    <input type="text" class="form-control" id="Username" aria-describedby="E-mail" value="{{$user->email}}"
                                ...
                                <div class="text-center">
                                    ...
                                    <a class="btn btn-light px-5 mb-5 w-50" href="{{route('usuarios.index')}}">Voltar</a>
                                </div>
                            </form>
